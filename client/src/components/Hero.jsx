  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10'>
        <div className='bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl'>
            ...
            <p className='mb-8 max-w-auto mx-auto text-sm font-light px-5'> Your Next Career Mover Strats Right Here - Explore the best Job opportunities and Take the first Step Toward career </p>
